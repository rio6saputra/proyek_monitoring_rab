<?php
// api/rekam_akun.php (Versi Final dengan Perbaikan Logika)
...
try {
    $sql_entry = "INSERT INTO RAB_Entry (ro_id, komponen_id, sub_komponen_id, sub_komponen_2_id, id_akun, kode_akun, tahun_anggaran, created_by_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    $stmt_entry = mysqli_prepare($koneksi, $sql_entry);
    mysqli_stmt_bind_param($stmt_entry, "ssssisii", $ro_id, $komponen_id, $sub_komponen_id, $sub_komponen_2_id, $id_akun, $kode_akun, $tahun_anggaran, $user_id);
