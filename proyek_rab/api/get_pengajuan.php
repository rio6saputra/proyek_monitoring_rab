<?php
// api/get_pengajuan.php (Versi Upgrade dengan Status Revisi)
...
try {
    ...
    $sql = "SELECT DISTINCT
                ...
                bag.bagian_id,
                bag.nama_bagian,
                -- Kolom baru untuk membedakan tipe pengajuan di frontend
                CASE
                    WHEN e.status_anggaran = 'MENUNGGU_VERIFIKASI' THEN 'Baru'
                    WHEN e.status_anggaran = 'REVISI_MENUNGGU_VERIFIKASI' THEN 'Revisi'
                    ELSE 'Lainnya'
            ...
            -- Ambil kedua status yang menunggu verifikasi
            WHERE e.status_anggaran IN ('MENUNGGU_VERIFIKASI', 'REVISI_MENUNGGU_VERIFIKASI')
