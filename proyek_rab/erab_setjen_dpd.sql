...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 18 Sep 2025 pada 03.35
...
INSERT INTO `rab_detail` (`id_rab_detail`, `rab_entry_id`, `parent_detail_id`, `uraian_pekerjaan`, `harga_satuan`, `harga_satuan_revisi`, `total_biaya`, `total_biaya_revisi`, `volume_data_revisi`, `catatan`, `status_revisi`, `catatan_revisi`) VALUES
(71, 18, NULL, 'Honor Output Kegiatan', 11000000.00, NULL, 330000000.00, NULL, NULL, NULL, 'ORIGINAL', NULL);
...
(18, '7983.AAA.001', '7983.AAA.001.051', '7983.AAA.001.051.A', NULL, 2, '521213', 0, 'MENUNGGU_VERIFIKASI', '2025', 1, '2025-09-17 01:46:21', '2025-09-17 09:02:07');

-- --------------------------------------------------------

--
-- Struktur dari tabel `rab_volume`
--

CREATE TABLE `rab_volume` (
  `id_rab_volume` int(11) NOT NULL,
...
--
-- Dumping data untuk tabel `rab_volume`
--

INSERT INTO `rab_volume` (`id_rab_volume`, `rab_detail_id`, `volume`, `satuan`) VALUES
(157, 71, 5.00, 'Orang'),
(158, 71, 6.00, 'Kegiatan'),
(159, 71, 1.00, 'RUU');
...
--
-- Indeks untuk tabel `rab_volume`
--
ALTER TABLE `rab_volume`
  ADD PRIMARY KEY (`id_rab_volume`),
  ADD KEY `rab_detail_id` (`rab_detail_id`);
...
--
ALTER TABLE `rab_detail`
  MODIFY `id_rab_detail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;

--
-- AUTO_INCREMENT untuk tabel `rab_entry`
--
ALTER TABLE `rab_entry`
  MODIFY `id_rab_entry` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT untuk tabel `rab_volume`
--
ALTER TABLE `rab_volume`
  MODIFY `id_rab_volume` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=160;
...
--
-- Ketidakleluasaan untuk tabel `rab_volume`
--
ALTER TABLE `rab_volume`
  ADD CONSTRAINT `rab_volume_ibfk_1` FOREIGN KEY (`rab_detail_id`) REFERENCES `rab_detail` (`id_rab_detail`) ON DELETE CASCADE;
